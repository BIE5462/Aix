          ...
          <div v-if="isSoraModel" class="settings-section vertical-layout compact-section">
            ...
            >
              ...
              <div style="font-size: 12px; line-height: 1.6; margin-top: 4px;">
                ...
                <p style="margin: 8px 0 4px 0; color: var(--color-primary);">
  ...
  previewWindow.document.write(`
    <html>
      <head>
        ...
        <style>
          body { margin: 0; padding: 20px; background: var(--bg-primary); display: flex; justify-content: center; align-items: center; min-height: 100vh; }
      ...
      ">
        ...
        ">
          ...
          <div style="margin-bottom: 16px;">
            <label style="display: block; margin-bottom: 8px; font-weight: 500; color: var(--text-muted);">标题</label>
          ...
          <div style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 8px; font-weight: 500; color: var(--text-muted);">内容</label>
